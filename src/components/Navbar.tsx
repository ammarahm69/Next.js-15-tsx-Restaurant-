...
const Navbar = () => {
    ...
    return (
        <nav className="absolute top-0 w-full z-50">
            {/* --------- Top Bar --------- */}
            <div className="bg-black px-4 sm:px-6 lg:px-8 py-2 sm:py-3">
            ...
            <div className="bg-black bg-opacity-70 border-t border-b border-gray-700">
                <div className="max-w-7xl mx-auto flex items-center justify-between py-2 sm:py-3 px-4 sm:px-6 lg:px-8">
                    {/* Desktop Navigation */}
                ...
                >
                    <div className="flex justify-between items-center p-6 border-b border-gray-700">
                        ...
                        <button
                            ...
                            className="text-[#DCBB75] w-8 h-8 flex items-center justify-center"
                        >
                            <svg
                                className="w-6 h-6"
                                fill="none"
                    ...
                    <div className="max-w-7xl mx-auto px-6 py-4">
                        <div className="flex flex-col space-y-6 pb-6 border-b border-gray-700">
                            {navItems.map((item) => (
                                <a
                                    key={item.name}
                                    href={item.href}
                                    className="text-white border-b border-gray-800 pb-3 text-base font-medium tracking-wide hover:text-[#DCBB75] transition-colors flex items-center"
                                    onClick={() => setIsMenuOpen(false)}
                                >
                                    {item.name}
                        ...
                        <div className="py-6 border-b border-gray-700">
                            <div className="flex items-center justify-between mb-6">
                                <div className="flex items-center space-x-2 text-white">
                                    <span role="img" aria-label="flag" className="text-lg">🇬🇧</span>
                            ...
                            <button className="w-full py-3 bg-gradient-to-r from-[#AD8749] to-[#DCBB75] text-white text-base font-medium rounded-lg hover:opacity-90 transition-opacity">
                                Log in
                            </button>
                        </div>
                        ...
                        {/* Social Icons */}
                        <div className="pt-6">
                            <h3 className="text-gray-400 text-sm font-medium uppercase tracking-wider mb-4">Follow Us</h3>
                            <div className="flex space-x-6">
                                <a href="#" className="text-white hover:text-[#DCBB75] transition-colors" aria-label="Instagram">
                                    <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                                        <path d="M12 2.163c3.204 0 3.584.012 4.85.07 3.252.148 4.771 1.691 4.919 4.919.058 1.265.069 1.645.069 4.849 0 3.205-.012 3.584-.069 4.849-.149 3.225-1.664 4.771-4.919 4.919-1.266.058-1.644.07-4.85.07-3.204 0-3.584-.012-4.849-.07-3.26-.149-4.771-1.699-4.919-4.92-.058-1.265-.07-1.644-.07-4.849 0-3.204.013-3.583.07-4.849.149-3.227 1.664-4.771 4.919-4.919 1.266-.057 1.645-.069 4.849-.069zm0-2.163c-3.259 0-3.667.014-4.947.072-4.358.2-6.78 2.618-6.98 6.98-.059 1.281-.073 1.689-.073 4.948 0 3.259.014 3.668.072 4.948.2 4.358 2.618 6.78 6.98 6.98 1.281.058 1.689.072 4.948.072 3.259 0 3.668-.014 4.948-.072 4.354-.2 6.782-2.618 6.979-6.98.059-1.28.073-1.689.073-4.948 0-3.259-.014-3.667-.072-4.947-.196-4.354-2.617-6.78-6.979-6.98-1.281-.059-1.69-.073-4.949-.073zm0 5.838c-3.403 0-6.162 2.759-6.162 6.162s2.759 6.163 6.162 6.163 6.162-2.759 6.162-6.163c0-3.403-2.759-6.162-6.162-6.162zm0 10.162c-2.209 0-4-1.79-4-4 0-2.209 1.791-4 4-4s4 1.791 4 4c0 2.21-1.791 4-4 4zm6.406-11.845c-.796 0-1.441.645-1.441 1.44s.645 1.44 1.441 1.44c.795 0 1.439-.645 1.439-1.44s-.644-1.44-1.439-1.44z"/>
                                    </svg>
                                </a>
                                <a href="#" className="text-white hover:text-[#DCBB75] transition-colors" aria-label="Twitter">
                                    <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                                        <path d="M23.953 4.57a10 10 0 01-2.825.775 4.958 4.958 0 002.163-2.723c-.951.555-2.005.959-3.127 1.184a4.92 4.92 0 00-8.384 4.482C7.69 8.095 4.067 6.13 1.64 3.162a4.822 4.822 0 00-.666 2.475c0 1.71.87 3.213 2.188 4.096a4.904 4.904 0 01-2.228-.616v.06a4.923 4.923 0 003.946 4.827 4.996 4.996 0 01-2.212.085 4.936 4.936 0 004.604 3.417 9.867 9.867 0 01-6.102 2.105c-.39 0-.779-.023-1.17-.067a13.995 13.995 0 007.557 2.209c9.053 0 13.998-7.496 13.998-13.985 0-.21 0-.42-.015-.63A9.935 9.935 0 0024 4.59z"/>
                                    </svg>
                                </a>
                                <a href="#" className="text-white hover:text-[#DCBB75] transition-colors" aria-label="Facebook">
                                    <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                                        <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
                                    </svg>
                                </a>
                                <a href="#" className="text-white hover:text-[#DCBB75] transition-colors" aria-label="TikTok">
                                    <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                                        <path d="M12.525.02c1.31-.02 2.61-.01 3.91-.02.08 1.53.63 3.09 1.75 4.17 1.12 1.11 2.7 1.62 4.24 1.79v4.03c-1.44-.05-2.89-.35-4.2-.97-.57-.26-1.1-.59-1.62-.93-.01 2.92.01 5.84-.02 8.75-.08 1.4-.54 2.79-1.35 3.94-1.31 1.92-3.58 3.01-5.92 2.97-2.34-.05-4.52-1.3-5.88-3.23-1.33-1.95-1.5-4.58-.52-6.68 1.01-2.18 3.21-3.6 5.56-3.65.13 0 .27.01.4.01v3.31c-.22-.01-.44-.04-.66-.06-.83-.07-1.68.14-2.4.53-.69.38-1.22 1.02-1.48 1.77-.36 1.12-.2 2.4.42 3.39.62.99 1.71 1.61 2.85 1.66 1.62.07 3.06-.9 3.56-2.42.2-.59.24-1.23.23-1.85.01-2.8 0-5.6.01-8.4v-8.69h3.27v5.49c1.25-.8 2.67-1.27 4.15-1.32.02-.2.03-.4.03-.6.01-1.8.01-3.6 0-5.4z"/>
                                    </svg>
                                </a>
                            </div>
                        </div>
